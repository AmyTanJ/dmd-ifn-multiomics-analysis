# IFN-related Analyses in DMD

This directory contains analysis notebooks related to **type I interferon (IFN) signaling** in Duchenne muscular dystrophy (DMD).

The workflows are used to examine interferon-associated transcriptional programs and immune phenotypes across experimental conditions.
...
- Used to map macrophage clusters
